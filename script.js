...
function updatePageTitle(pageId) {
    const pageTitles = {
        'home': 'NeuroNix - Home Dashboard',
        'alerts': 'NeuroNix - Alert Management',
        'simulation': 'NeuroNix - Fire Simulation & Evacuation',
        'resources': 'NeuroNix - Resource Optimization',
        'community': 'NeuroNix - Community Training',
        'recovery': 'NeuroNix - Recovery Planning',
        'explainability': 'NeuroNix - AI Explainability'
    };
    
    document.title = pageTitles[pageId] || 'NeuroNix - Forest Fire Intelligence';
}
...
function enableDemoMode() {
    ...
    showToast('Demo Mode Enabled - Preloaded Nainital Fire Scenario', 'info', 4000);
    
    // Auto-start simulation after a delay
    setTimeout(() => {
        startFireSimulation({ lat: 29.3806, lng: 79.4422 });
        showToast('Nainital Fire Simulation Started', 'success');
    }, 2000);
}
...
function initializeRecoveryMapping() {
    // Recovery mapping initialization
    console.log('Recovery mapping initialized');
}
